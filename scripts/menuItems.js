...
function onOpen() {
    ...
    var entries = [{
            name: 'Add column on all sheets',
            functionName: 'addColumnOnAllSheets'
        },
        {
            name: 'Remove column on all sheets',
            functionName: 'removeColumnOnAllSheets'
        },
        {
            name: 'Set weeks from Template',
            functionName: 'setWeeksFromTemplate'
        }
    ];
